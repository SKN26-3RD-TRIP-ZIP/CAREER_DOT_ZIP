...
| 박소윤 | PM | 로그인·회원가입 구현 / 인증·자료 입력 화면 구현 |
...
- [Backend README](./CAREER_DOT_ZIP_BACKEND/README.md)
- [Frontend README](./CAREER_DOT_ZIP_FRONTEND/README.md)
...
| 팀원 | 회고 기법 | 핵심 회고 | 상세 |
|---|---|---|---|
| 김이선 | STAR-L, 5 Whys | 어드민 기능을 구현하며 기능 완료 기준에 성능과 유지보수성 검토가 포함되어야 한다는 점을 배웠습니다. | [회고 보기](./docs/retrospectives/kim-iseon.md) |
